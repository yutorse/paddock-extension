...
let day = ("0" + raceInfo.split("年")[1].split("月")[1].split("日")[0]).slice(
  -2
);
...
let oddsButtonElement = document.getElementsByClassName(
  "btn-def btn-sm blue btn-block"
)[0];
let paddockButtonElement = `<a href=${url} target="_blank" id='paddock-button' class='btn-def btn-sm blue btn-block mt5'><i class='fa fa-chevron-circle-right'></i>パドック</a>`;
